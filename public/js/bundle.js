...
exports.user_url = exports.post_url = void 0;
var user_url = exports.user_url = "http://127.0.0.1:5000/api/users";
var post_url = exports.post_url = "http://127.0.0.1:5000/api/posts";
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status == "success") {
            ...
            document.querySelector(".profile-form-div-id").querySelectorAll("input, textarea, select, button").forEach(function (input) {
              input.disabled = true;
            });
...
},{"./alerts":"alerts.js","./config":"config.js","axios":"../../node_modules/axios/index.js"}],"createPost.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status == "success") {
            (0, _alerts.showAlert)("success", "Post Has Been Create 🎉");
            window.setTimeout(function () {
              location.assign("/");
            }, 1000);
          }
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"postSettings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePost = exports.deletePost = void 0;
var _alerts = require("./alerts");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var updatePost = exports.updatePost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, category, description, id) {
    var base_url, res, _err$response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: "".concat(base_url, "/api/posts/updatePost/").concat(id),
            data: {
              name: name,
              category: category,
              description: description
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Updated Post Successfully");
            window.setTimeout(function () {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)((_context.t0 === null || _context.t0 === void 0 || (_err$response = _context.t0.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || "Something Went Wrong Try Again!!");
        case 11:
        case "end":
          return _context.stop();
      }
  ...
  return function updatePost(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
var deletePost = exports.deletePost = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
    var base_url, res, _err$response2;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          ...
          return (0, _axios.default)({
            method: "DELETE",
            url: "".concat(base_url, "/api/posts/").concat(id)
          });
        case 4:
          res = _context2.sent;
        ...
        case 8:
          _context2.prev = 8;
          _context2.t0 = _context2["catch"](0);
          (0, _alerts.showAlert)((_context2.t0 === null || _context2.t0 === void 0 || (_err$response2 = _context2.t0.response) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.data) === null || _err$response2 === void 0 ? void 0 : _err$response2.message) || "Something Went Wrong Try Again!!");
        case 11:
        case "end":
          return _context2.stop();
      }
...
var _alerts = require("./alerts");
var _postSettings = require("./postSettings");
var _document, _document2, _document3, _document4, _document$querySelect, _document5, _document6;
...
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; } // import { latesPosts } from "./latestPosts";
...
var profileForm = (_document3 = document) === null || _document3 === void 0 ? void 0 : _document3.querySelector(".profile-form-div-id");
var inputs = profileForm === null || profileForm === void 0 ? void 0 : profileForm.querySelectorAll("input, textarea, select, button");
if (inputs) {
...
(_document4 = document) === null || _document4 === void 0 || (_document4 = _document4.querySelector(".profile-edit-button")) === null || _document4 === void 0 || _document4.addEventListener("click", function () {
  inputs.forEach(function (input) {
    input.disabled = false;
  });
  document.querySelector(".profile-submit-btn").style.display = "block";
});
(_document$querySelect = document.querySelector(".profile-submit-btn")) === null || _document$querySelect === void 0 || _document$querySelect.addEventListener("click", function (e) {
  e.preventDefault();
  var email = document.getElementById("email").value;
...
(_document5 = document) === null || _document5 === void 0 || (_document5 = _document5.querySelector(".create-post-form")) === null || _document5 === void 0 || _document5.addEventListener("submit", function (e) {
  ...
  if (!name || !category || !description) {
    (0, _alerts.showAlert)("error", "All Fields Are Mandatory");
    return;
  }
  (0, _createPost.createPost)(name, description, category);
});
(_document6 = document) === null || _document6 === void 0 || (_document6 = _document6.querySelector(".signup-form-div")) === null || _document6 === void 0 || _document6.addEventListener("submit", function (e) {
  e.preventDefault();
  var name = document.getElementById("name").value;
  var email = document.getElementById("email").value;
...
function getFormNumber(classNames, nameRecived) {
  var formNumber;
  classNames.forEach(function (curr) {
...
document.querySelectorAll(".post-btns-button").forEach(function (button) {
  button.addEventListener("click", function (e) {
    ...
    if (classNames.includes("post-edit-btn")) {
      ...
      var name = document.querySelector(".title-".concat(num)).value;
      var category = document.querySelector(".category-".concat(num)).value;
...
//   latesPosts();
// });
},{"./auth":"auth.js","./updateUserData":"updateUserData.js","./createPost":"createPost.js","./alerts":"alerts.js","./postSettings":"postSettings.js"}]},{},["index.js"], null)
